...
# Deploy this Mule app to the partners CloudHub environment using the given env configuration
#
# Usage  : deploy-to-ch.sh <env>       <suffix> <vcores> <client-id>                      <client-secret>                  <secure-props-key>
# Example: deploy-to-ch.sh production  ''       0.1         e0............................99 FD............................85 securePropsCryptoKey
...
echo Anypoint Platform environment : $APENV
...
$mvns -DmuleDeploy deploy \
      -Ddeployment.env=$ENV -Dap.environment=$APENV \
      -Ddeployment.prefix=$PREFIX -Ddeployment.suffix=$SUFFIX \
